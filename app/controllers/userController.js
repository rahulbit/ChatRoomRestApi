...
const sendMail = require('./../../app//libs/sendmailLIb')
                    ...
                    if (err) {
                        ...
                        newUser.save((err, newUser) => {
                            if (err) {
                                ...
                                resolve(newUserObj)
                                logger.info('UserCreated succefully', 'userController', 10)
                                sendMail.sendWelcomeMail(newUserObj)
                            }
...
let forgot =(req,res)=>{
    ...
    {
        logger.error('email missing', 'forgotPassword', 10)
        ...
        UserModel.findOne({email:req.body.email}, (err, result)=>{
              ...
              else if(check.isEmpty(result))
              {
                ...
                logger.info("no data  found", "forgotPassword")
                let apiResponse = response.generate(true, "no   data found", 404,null)
                res.send(apiResponse)
              }

              else{
                     sendMail.sendResetPassMail(result)
